...
export const matchHelpText = (base = 12) => {
  const exprHelp = `<li>You may enter expressions with common operators such as <em>+</em>, <em>-</em>, <em>*</em>, <em>/</em> and <em>^</em> (power) as well as use parentheses, e.g. <em>(2 + 3)</em>, to group expressions.</em></li>`;
  switch (base) {
    case 12:
